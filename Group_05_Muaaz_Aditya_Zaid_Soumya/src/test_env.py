...
# Project: Collaborative Dual-UAV Campus Surveillance System
...
def run_environment_check():
    print("=" * 60)
    print("MDRIIA GROUP 05 - TOOLCHAIN AND PHYSICS VERIFICATION")
    print("=" * 60)
    ...
    try:
        ...
        xml_path = os.path.join(os.path.dirname(current_dir), "models", "campus_perimeter_patrol.xml")
        ...
        if os.path.exists(xml_path):
            ...
            print(f"[INFO] Model Bodies: {model.nbody}, Actuators: {model.nu}, Cameras: {model.ncam}")
        else:
