...
# Domain: 7-DOF Surgical Robotics & Tremor Suppression
...
def run_environment_verification():
    print("=" * 60)
    print("MDRIIA GROUP 10 - TOOLCHAIN AND PHYSICS VERIFICATION")
    print("=" * 60)
    ...
    try:
        ...
        model_path = os.path.join(os.path.dirname(__file__), "..", "models", "surgical_7dof_robot.xml")
