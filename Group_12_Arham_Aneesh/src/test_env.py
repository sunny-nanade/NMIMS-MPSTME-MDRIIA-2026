...
def verify_environment():
    print("==================================================================")
    print("MDRIIA GROUP 12: SMOKE TEST & PHYSICS ENVIRONMENT VERIFICATION")
    print("Domain: Autonomous Drone for Pipeline Surveillance & Defect Detection")
    print("Team: Arham Khan (E069), Aneesh Kumar (E076)")
    print("==================================================================")
    try:
        import mujoco
    ...
    model_path = os.path.join(os.path.dirname(script_dir), "models", "pipeline_surveillance_drone.xml")
